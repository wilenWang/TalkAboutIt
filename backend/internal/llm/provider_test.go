...
func TestFactory_CreateOpenAI(t *testing.T) {
	...
	openAIProv, ok := prov.(*OpenAIProvider)
	if !ok {
	...
	if openAIProv.Model() != "deepseek-chat" {
		t.Errorf("expected model deepseek-chat, got %s", openAIProv.Model())
	}
}
...
func TestFactory_CreateAnthropic(t *testing.T) {
	...
	anthProv, ok := prov.(*AnthropicProvider)
	if !ok {
...
func TestFactory_DefaultFallback(t *testing.T) {
	...
	if openAIProv.Model() != "deepseek-chat" {
		t.Errorf("expected default model deepseek-chat, got %s", openAIProv.Model())
	}
}
...
func TestNewProviderError_Classification(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := NewProviderError(tt.statusCode, "test body", nil)
